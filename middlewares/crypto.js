...
const secretKey = "{WaA8#*0T4dj+$UlK%^kj]l";
const smallSecretKey = 37472159;
...
function compareEncryptedData(data, encryptedData, is_smallEncrypt = 0) {
  if (is_smallEncrypt) {
    return data === smallDecrypt(encryptedData);
  }
  return data === decrypt(encryptedData);
}
